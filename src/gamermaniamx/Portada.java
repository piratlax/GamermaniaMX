...
public class Portada extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        AgregarConsola = new javax.swing.JMenuItem();
        jMenu2 = new javax.swing.JMenu();
        jMenu3 = new javax.swing.JMenu();
        jMenu4 = new javax.swing.JMenu();

        setDefaultCloseOperation(javax.swing.WindowConstants.EXIT_ON_CLOSE);
        setTitle("GamerManiaMX");
    ...
    private void AgregarConsolaActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_AgregarConsolaActionPerformed
       AgregarConsola agregarConsola=new AgregarConsola();
        escritorio.add(agregarConsola);
       agregarConsola.show();
    ...
    private javax.swing.JMenuItem AgregarConsola;
...
class GestorVentanas{
    boolean AgregarConsola;
    public GestorVentanas(){
    
    }
public boolean AgregarConsola(String estado){
    if (!AgregarConsola){
        return false;
    }else{
        return true;
